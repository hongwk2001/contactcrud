...
public class DataSource {
  ...
  private ContactRecord cursorToRow(Cursor cursor) {
	  ...
	  newrow.setFirstName (cursor.getString(0));
	  newrow.setLastName(cursor.getString(1));
	  newrow.setDateOfBirth(cursor.getString(2));
	  newrow.setZipCode(cursor.getString(3));
    return newrow;
  }
